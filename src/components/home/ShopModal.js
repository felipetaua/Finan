    ...
    const items = [
        {
            ...
            icon: 'treasure-chest',
            iconColor: '#1CB0F6',
            img: require('../../assets/images/store-chest.jpg'),
            buttonText: 'Abrir',
            subtext: '08:38:32',
            price: null,
        },
        {
            ...
            icon: 'snowflake',
            iconColor: '#1CB0F6',
            img: require('../../assets/images/store-heart-cold.png'),
            buttonText: 'Obter:',
            price: 132,
        },
        {
            ...
            iconColor: '#FF9600',
            img: require('../../assets/images/store-battery.jpg'),
            buttonText: 'Obter:',
            price: 132,
        },
        {
            ...
            icon: 'infinity',
            iconColor: '#8A2BE2',
            img: require('../../assets/images/store-infinity.png'),
            buttonText: 'Obter:',
            price: 132,
        },
        {
